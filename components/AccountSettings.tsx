          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                {isGoogleUser && (
                  <span className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2">
                    <svg viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" className="h-5 w-5">
