            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border px-4 py-3 text-sm outline-none ${isDark ? 'bg-slate-950 border-white/10 text-white' : 'bg-white border-slate-200 text-slate-900'} ${isGoogleUser ? `cursor-not-allowed pl-10 ${isDark ? 'bg-slate-900/60 border-white/5 text-slate-400' : 'bg-slate-100 border-slate-200 text-slate-500'}` : ''}`}
                />
              </div>
