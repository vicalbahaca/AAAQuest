...
<svg viewBox="0 0 256 256" className="w-8 h-8" fill="currentColor">
  <rect x="40" y="40" width="176" height="176" rx="20" fill="#6600CC"/>
  <path d="M80 100 L100 160 L120 100 M140 100 L160 160 L180 100" 
        stroke="white" 
        strokeWidth="12" 
        strokeLinecap="round" 
...
<svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
  <path d="M17.6 9.48l1.84-3.18c.16-.31.04-.69-.26-.85-.29-.15-.65-.06-.83.22l-1.88 3.24c-2.86-1.21-6.08-1.21-8.94 0L5.65 5.67c-.19-.28-.54-.38-.83-.22-.3.16-.42.54-.26.85L6.4 9.48C3.3 11.25 1.28 14.44 1 18h22c-.28-3.56-2.3-6.75-5.4-8.52zM7 15.25c-.69 0-1.25-.56-1.25-1.25s.56-1.25 1.25-1.25 1.25.56 1.25 1.25-.56 1.25-1.25 1.25zm10 0c-.69 0-1.25-.56-1.25-1.25s.56-1.25 1.25-1.25 1.25.56 1.25 1.25-.56 1.25-1.25 1.25z"/>
</svg>);
