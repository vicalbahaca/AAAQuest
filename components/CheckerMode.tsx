        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6 lg:gap-0 mb-8">
           ...
           <div className="flex flex-wrap gap-3 w-full lg:w-auto">
              ...
              <button 
                ...
                className="flex-1 lg:flex-none justify-center items-center flex gap-2 px-5 py-2 border border-transparent hover:border-white/20 rounded-xl text-sm font-normal text-white transition-all active:scale-95 bg-[#038759] hover:bg-[#026e49] shadow-lg shadow-emerald-900/30"
              >
